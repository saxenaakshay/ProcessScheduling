					...
					/* array in the code)		*/
{
	...
	pptr->tq = 0;	/* initial time quantum value = priority*/
	pptr->goodness = priority*2;	/* created process's goodness is priority + time quantum */
	pptr->isinepoch = FALSE;	/* created process to wait for current epoch to complete */
		/* Bottom of stack */
	*saddr = MAGIC;
